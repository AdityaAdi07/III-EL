...
<head>
    ...
    <title>Course|Balake Kannada</title>
...
<body>
 ...
 <div class="sidebar"><div><a href="index.php"><img class="home" src="/Images/HomeIcon.png"></a></div>
    ...
    <div class="course_info"><p class="coursedescription">Course Description:</p> 
        <div><p class="course_description">Balake Kannada-HSS113BK/HSS123BK,First Semester B.E. Electronics And Instrumentation Engineering</p></div>
       <DIV>
       ...
       <div class="quizcontent">
        <div class="coursetitle">
            <p class="coursetitle">Balake Kannada-HSS113BK/HSS123BK</p>
            </div>
