...
<head>
    ...
    .email{
        ...
        font-size:20px;
        font-family:arial;
        border-color:rgba(255, 0, 0, 0.763);
...
<div class="box">
    ...
    <input id="text" type="text" name="user_name" placeholder="Email " class="email">
    <p class="star">*</p><p class="Please">Please enter valid email or password.</p>
     ...
     <div class="login_buttons">
      <button type="submit" value="login" class="loginbutton">Login</button></a>
     <button type="submit" class="signup"><a href="/adminlogin.php">Admin ? Click here to login</a></button>
     </div>
</form>
...
<div class="contact">
   ...
   <div><img class="instaicon" src="/Images/insta-removebg-preview.png"><p class="insta">Insta: <a class="instaid" href="https://instagram.com/_pavan_ganesha?igshid=OGQ5ZDc2ODk2ZA==" target="_main"s>@Quizzer</a></p></div>
