...
<head>
    ...
    <title>Course|Electronics</title>
...
<body>
 ...
 <div class="sidebar"><div><a href="index.php"><img class="home" src="/Images/HomeIcon.png"></a></div>
    ...
    <div class="course_info"><p class="coursedescription">Course Description:</p> 
        <div><p class="course_description">Basic Electronics-EC112AT,First Semester B.E. Electronics And Instrumentation Engineering</p></div>
       <DIV>
        <div><p class="teacher">Teacher In Charge :</p> </div>
        <div class="kiran_"><img class="profilepic" src="/Images/Profile-logo.png"><p class="kiran"> Dr.RACHANA S AKKI</p></div>
        </div>
       </div></div>
       <div class="quizcontent">
        <div class="coursetitle">
            <p class="coursetitle">Basic Electronics-EC112AT</p>
            </div>
