...
<section class="container py-lg-5">
  <!--User table-->
    <h1 class="slideInDown animated">Employees Daily Report</h1>
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg animate" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h3 class="modal-title" id="exampleModalLongTitle">Filter Your employee Log:</h3>
              ...
              <div class="container-fluid">
                ...
                <div class="row">
                  <div class="col-lg-4 col-sm-12">
                    <label for="Fingerprint" class="Filter_title"><b>Filter By employee:</b></label>
