...
<body>
 ...
 <div class="sidebar"><div><a href="index.php"><img class="home" src="/Images/HomeIcon.png"></a></div>
    ...
    <div class="course_info"><p class="coursedescription">Course Description:</p> 
        <div><p class="course_description">Innovation and Design Thinking Lab-22ME18,First Semester B.E. Electronics And Instrumentation Engineering</p></div>
       <DIV>
        <div><p class="teacher">Teacher In Charge :</p> </div>
        <div class="kiran_"><img class="profilepic" src="/Images/Profile-logo.png"><p class="kiran"> SUJAN CHAKRABORTY</p></div>
        </div>
       </div></div>
       <div class="quizcontent">
        <div class="coursetitle">
            <p class="coursetitle">Innovation and Design Thinking Lab-22ME18</p>
            </div>
